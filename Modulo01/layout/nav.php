    ...
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasScrollingLabel"><img src="imgs/quizz&logo/logoEGP2.png" alt="logo"
                        id="img_logo">
                </h5>
                ...
                <nav class="menulateral-responsivo">
                    <ul>
                        ...
                        <button class="dropdown-btn">
                            <li class="menu">
                                <a data-valor="topico02.html">
                                    ...
                                    <span class="txt">Interação Humano-Computador<i
                        ...
                        <div class="dropdown-container" id="spy">
                            ...
                            <a href="#item1">
                                <i class="fa-regular fa-pen-to-square circulo"></i>2.1 - Áreas de Estudo em IHC</a>
                        ...
                        <li class="menu">
                            <a href="topico04.php">
                                ...
                                <span class="txt">Quem é usuário?</span>
                            </a>
                        </li>
