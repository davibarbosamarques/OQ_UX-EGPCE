...
<nav class="menulateral shadow-lg">
        ...
        <ul>
            ...
            <button class="dropdown-btn">
                <li class="menu">
                    <a data-valor="topico01.php">
                        ...
                        <span class="txt">Interação Humano-Computador<i class="bi bi-caret-down-fill barra-sub"></i></span>
                    </a>
                </li>
            </button>
            <!-- subtopicos aqui  -->
            <div class="dropdown-container" id="spy">
                ...
                <a href="#item1">
                    <i class="fa-regular fa-pen-to-square circulo"></i>áreas de estudo em IHC</a>
            </div>
